...
%><%@include file="/libs/foundation/global.jsp"%><%
	...
	String dialog = "/apps/cognifide/securecq/renderers/testRenderer/dialog";
...
<body>
    <div id="header"><a href="/etc/securecq.html" class="home"></a></div>
    <h1><%= pageTitle %></h1>
    <div>
    <br/>
    <script type="text/javascript">
        CQ.WCM.edit({
            ...
            "dialog":"<%= dialog %>",
            "type":"cognifide/securecq/renderers/testRenderer",
            "editConfig":{
                "xtype":"editbar",
                "listeners":{
